...
| <center> <img width="500" src="/images/edge-case-clusters.png"/> </center>                                    |
| --------------------------------------------------------------------------------------------------------------|
| <center>Edge cases clusters selected by the framework. Pushup orientations are most prominent.</center>       | 
