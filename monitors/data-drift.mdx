...
| <center> <img width="500" src="https://uptrain-demo.s3.us-west-1.amazonaws.com/human_orientation_classification/1_data_drift_and_edge_cases.gif"/> </center> |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <center>Data Drift monitor in the UpTrain dashboard</center>                                                                                                 | 
...
| <center> <img width="500" src="/images/earth-moving-distance.png"/> </center>                                    |
| -----------------------------------------------------------------------------------------------------------------|
| <center>Earth moving distance vs number of predictions</center>                                                  | 
...
| <center> <img width="500" src="/images/feature-distribution.png"/> </center>                                     |
| -----------------------------------------------------------------------------------------------------------------|
...
| <center> <img width="500" src="/images/data-drift-alert.png"/> </center>                                         |
| -----------------------------------------------------------------------------------------------------------------|
| <center>Data Drift alert on UpTrain dashboard </center>                                                          | 
